...
use bevy_ecs::{
    ...
    component::Component,
    entity::Entity,
    event::{EventReader, EventWriter, GlobalEvent},
    name::Name,
...
#[derive(GlobalEvent, Debug, Clone, PartialEq, From)]
#[cfg_attr(
...
#[derive(GlobalEvent, Debug, Copy, Clone, PartialEq)]
#[cfg_attr(
    feature = "bevy_reflect",
    derive(Reflect),
    reflect(Debug, PartialEq, Clone)
...
#[derive(GlobalEvent, Debug, Clone, Copy, PartialEq, Eq)]
#[cfg_attr(
    feature = "bevy_reflect",
    derive(Reflect),
    reflect(Debug, PartialEq, Clone)
...
#[derive(GlobalEvent, Debug, Clone, Copy, PartialEq)]
#[cfg_attr(
    feature = "bevy_reflect",
    derive(Reflect),
    reflect(Debug, PartialEq, Clone)
