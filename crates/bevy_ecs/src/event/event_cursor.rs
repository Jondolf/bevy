use bevy_ecs::event::{
    EventIterator, EventIteratorWithId, EventMutIterator, EventMutIteratorWithId, Events,
    GlobalEvent,
};
...
/// use bevy_ecs::event::{GlobalEvent, Events, EventCursor};
///
...
#[derive(Debug)]
pub struct EventCursor<E: GlobalEvent> {
    pub(super) last_event_count: usize,
    pub(super) _marker: PhantomData<E>,
}

impl<E: GlobalEvent> Default for EventCursor<E> {
    fn default() -> Self {
        EventCursor {
            last_event_count: 0,
...
impl<E: GlobalEvent> Clone for EventCursor<E> {
    fn clone(&self) -> Self {
        EventCursor {
...
impl<E: GlobalEvent> EventCursor<E> {
