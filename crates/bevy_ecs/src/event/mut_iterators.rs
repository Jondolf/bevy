...
use bevy_ecs::event::{EventCursor, EventId, EventInstance, Events, GlobalEvent};
...
#[derive(Debug)]
pub struct EventMutIterator<'a, E: GlobalEvent> {
    iter: EventMutIteratorWithId<'a, E>,
}

impl<'a, E: GlobalEvent> Iterator for EventMutIterator<'a, E> {
    type Item = &'a mut E;
...
impl<'a, E: GlobalEvent> ExactSizeIterator for EventMutIterator<'a, E> {
    fn len(&self) -> usize {
        self.iter.len()
    }
}
...
/// [`EventMutator`]: super::EventMutator
#[derive(Debug)]
pub struct EventMutIteratorWithId<'a, E: GlobalEvent> {
    mutator: &'a mut EventCursor<E>,
    chain: Chain<IterMut<'a, EventInstance<E>>, IterMut<'a, EventInstance<E>>>,
    unread: usize,
}

impl<'a, E: GlobalEvent> EventMutIteratorWithId<'a, E> {
...
impl<'a, E: GlobalEvent> Iterator for EventMutIteratorWithId<'a, E> {
...
impl<'a, E: GlobalEvent> ExactSizeIterator for EventMutIteratorWithId<'a, E> {
    fn len(&self) -> usize {
        self.unread
    }
}

/// A parallel iterator over `GlobalEvent`s.
#[derive(Debug)]
#[cfg(feature = "multi_threaded")]
pub struct EventMutParIter<'a, E: GlobalEvent> {
    mutator: &'a mut EventCursor<E>,
...
#[cfg(feature = "multi_threaded")]
impl<'a, E: GlobalEvent> EventMutParIter<'a, E> {
    ...
    /// Returns the number of [`GlobalEvent`]s to be iterated.
...
#[cfg(feature = "multi_threaded")]
impl<'a, E: GlobalEvent> IntoIterator for EventMutParIter<'a, E> {
