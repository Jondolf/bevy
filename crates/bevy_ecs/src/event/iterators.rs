...
#[derive(Debug)]
pub struct EventIterator<'a, E: GlobalEvent> {
    iter: EventIteratorWithId<'a, E>,
}

impl<'a, E: GlobalEvent> Iterator for EventIterator<'a, E> {
    type Item = &'a E;
...
impl<'a, E: GlobalEvent> ExactSizeIterator for EventIterator<'a, E> {
    fn len(&self) -> usize {
        self.iter.len()
    }
}
...
#[derive(Debug)]
pub struct EventIteratorWithId<'a, E: GlobalEvent> {
    reader: &'a mut EventCursor<E>,
    chain: Chain<Iter<'a, EventInstance<E>>, Iter<'a, EventInstance<E>>>,
    unread: usize,
}

impl<'a, E: GlobalEvent> EventIteratorWithId<'a, E> {
...
impl<'a, E: GlobalEvent> Iterator for EventIteratorWithId<'a, E> {
...
impl<'a, E: GlobalEvent> ExactSizeIterator for EventIteratorWithId<'a, E> {
    fn len(&self) -> usize {
        self.unread
    }
}
...
#[cfg(feature = "multi_threaded")]
#[derive(Debug)]
pub struct EventParIter<'a, E: GlobalEvent> {
    reader: &'a mut EventCursor<E>,
...
#[cfg(feature = "multi_threaded")]
impl<'a, E: GlobalEvent> EventParIter<'a, E> {
...
#[cfg(feature = "multi_threaded")]
impl<'a, E: GlobalEvent> IntoIterator for EventParIter<'a, E> {
