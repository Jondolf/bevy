...
use bevy_ecs::{
    ...
    event::{EventCursor, EventId, EventInstance, GlobalEvent},
    resource::Resource,
};
use core::{
    marker::PhantomData,
...
/// # Example
/// ```
/// use bevy_ecs::event::{GlobalEvent, Events};
///
/// #[derive(GlobalEvent)]
/// struct MyEvent {
///     value: usize
...
pub struct Events<E: GlobalEvent> {
...
impl<E: GlobalEvent> Default for Events<E> {
    fn default() -> Self {
        Self {
...
impl<E: GlobalEvent> Extend<E> for Events<E> {
    #[track_caller]
...
pub(crate) struct EventSequence<E: GlobalEvent> {
    pub(crate) events: Vec<EventInstance<E>>,
    pub(crate) start_event_count: usize,
}

// Derived Default impl would incorrectly require E: Default
impl<E: GlobalEvent> Default for EventSequence<E> {
    fn default() -> Self {
        Self {
...
impl<E: GlobalEvent> Deref for EventSequence<E> {
...
impl<E: GlobalEvent> DerefMut for EventSequence<E> {
...
impl<E: GlobalEvent> Iterator for SendBatchIds<E> {
    type Item = EventId<E>;
...
impl<E: GlobalEvent> ExactSizeIterator for SendBatchIds<E> {
    fn len(&self) -> usize {
