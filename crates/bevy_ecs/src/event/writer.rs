...
/// trigger any [`Observer`]s watching for that event, as each [`GlobalEvent`] has different requirements regarding _if_ it will
...
#[derive(SystemParam)]
pub struct EventWriter<'w, E: GlobalEvent> {
    #[system_param(validation_message = "GlobalEvent not initialized")]
    events: ResMut<'w, Events<E>>,
}

impl<'w, E: GlobalEvent> EventWriter<'w, E> {
